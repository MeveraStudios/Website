...
| Command | Description |
|---------|-------------|
| `/currency give <currency> <player> <amount>` | Give currency to a player |
| `/currency take <currency> <player> <amount>` | Remove currency from a player |
| `/currency set <currency> <player> <amount>` | Set exact balance |
| `/currency randomgive <currency> <player> <min> <max>` | Give a random amount |
