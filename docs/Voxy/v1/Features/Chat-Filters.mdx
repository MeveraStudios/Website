...
|------|-----------|-------|
| Word / phrase (`WordFilter`) | A list of literal words or phrases | Straightforward exact-text matching |
| Regex (`PatternFilter`) | A list of regular-expression patterns | Patterns are combined and matched case-insensitively; matched text is replaced with `***` |
