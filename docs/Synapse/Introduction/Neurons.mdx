...
<Tabs groupId="synapse-platforms">
  <TabItem 
    ...
    label={
      <>
        <img src="https://github.com/MeveraStudios/Website/tree/main/assets/hytale.png" alt="Hytale Logo" style={{ height: 20, marginRight: 6, position: "relative", top: 2 }} />
        Hytale
      </>
    }
  >
...
```
  ...
  <TabItem 
    ...
    label={
      <>
        <img src="https://github.com/MeveraStudios/Website/tree/main/assets/bukkit.png" alt="Bukkit Logo" style={{ height: 20, marginRight: 6, position: "relative", top: 2 }} />
        Bukkit/Paper
      </>
    }
  >
...
```
  ...
  <TabItem 
    ...
    label={
      <>
        <img src="https://github.com/MeveraStudios/Website/tree/main/assets/bungeecord.png" alt="BungeeCord Logo" style={{ height: 20, marginRight: 6, position: "relative", top: 4 }} />
        BungeeCord
      </>
    }
  >
...
```
  ...
  <TabItem 
    ...
    label={
      <>
        <img src="https://github.com/MeveraStudios/Website/tree/main/assets/velocity_logo.svg" alt="Velocity Logo" style={{ height: 20, marginRight: 6, position: "relative", top: 2 }} />
        Velocity
      </>
    }
  >
