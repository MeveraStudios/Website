...
<Tabs groupId="synapse-platforms">
  ...
  • And then to our build tool!
    <LatestVersionBlock 
      ...
      id="synapse-hytale" 
    />
  • The Synapse class in this case is: ``HytaleSynapse``
  ...
  • And then to our build tool!
    <LatestVersionBlock 
      ...
      id="synapse-bukkit" 
    />
  • The Synapse class in this case is: ``BukkitSynapse``
  ...
  • And then to our build tool!
    <LatestVersionBlock 
      ...
      id="synapse-bungee" 
    />
  • The Synapse class in this case is: ``BungeeSynapse``
  ...
  • And then to our build tool!
    <LatestVersionBlock 
      ...
      id="synapse-velocity" 
    />
  • The Synapse class in this case is: ``VelocitySynapse``
