...
class MyPlugin : JavaPlugin() {
    ...
    lateinit var imperat: BukkitImperat<BukkitCommandSource>
...
> The `BukkitImperat<BukkitCommandSource>` witness is required since v4 parameterizes the platform Imperat over its canonical source type. See [Custom Sources](../Execution-Pipeline/Custom-Sources) for the custom-source path.
