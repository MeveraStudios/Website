...
:::note
We overridded the `getSuggestionResolver` method to provide dynamic suggestions based on the available ranks in the registry.
...
public class RankCommand {
    ...
    public void setRank(PLATFORMSOURCE source, Rank rank) {
        ...
        source.reply("/rank <rank> setpermission <user>");
    }
    ...
    public class SetPermission {
        ...
        @Execute
        public void setFor(PLATFORMSOURCE source, Rank rank, String user) {
            // In a real implementation, you would set the specified player's rank here.
            source.reply("Set " + user + "'s rank to " + rank);
        }
