...
### Main Pathway
It is the first pathway to be defined for a command with **ATLEAST** one required argument.
example pathway: `/print <message>`.
In this pathway, the command is `print` and it has one required argument `message`.

### Default Pathway
**It is the unique pathway without any required arguments, it can have no OR optional arguments.**
...
example pathway: `/print` or `/print [message]`.
