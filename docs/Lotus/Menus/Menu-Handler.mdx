...
`[LOTUS_RESULT_PLACEHOLDER]` The player opens a guarded menu, clicks a wrong slot, receives a
warning message, and only the center button is allowed to execute its action.
</Admonition>
