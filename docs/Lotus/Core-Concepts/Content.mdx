...
If your next problem is "I have several objects and need to place them across slots in order,"
continue to [Slot Iterator](/docs/Lotus/Slot-Iterator). Otherwise, jump ahead to
[The Menu Template](/docs/Lotus/Menu-Template).
