...
`[LOTUS_RESULT_PLACEHOLDER]` Clicking a lamp button swaps the slot from an "off" icon to an "on"
icon in the same position.
</Admonition>
...
<Admonition type="custom" sideColor="#06b6d4" bgColor="#06b6d420" title="RESULT PLACEHOLDER" icon="Info">
`[LOTUS_RESULT_PLACEHOLDER]` A single wide banner occupies several adjacent slots and clicking any
part of it triggers the same action.
</Admonition>
...
<Admonition type="custom" sideColor="#06b6d4" bgColor="#06b6d420" title="RESULT PLACEHOLDER" icon="Info">
`[LOTUS_RESULT_PLACEHOLDER]` Repeated clicks on one slot rotate through OFF, WHITELIST, and
BLACKLIST visual states.
</Admonition>
