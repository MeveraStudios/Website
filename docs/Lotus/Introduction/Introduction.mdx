...
4. [Menus](/docs/Lotus/Menu-Template) to learn templates, live views, and handler hooks.
5. [Buttons](/docs/Lotus/Button-Variants) to learn the six built-in button types.
6. [Pagination](/docs/Lotus/Pagination) once you are ready for scrollable lists.
